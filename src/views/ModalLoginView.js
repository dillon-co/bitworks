...
class ModalLoginView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/ModalLoginController')
  ...
  componentDidMount() {
    ...
    htmlEl.dataset['wfPage'] = '64161dd221beab1fdec4f16f'
  ...
  render() {
    const proxies = ModalLoginView.Controller !== ModalLoginView ? transformProxies(this.props.children) : {
          ...
          <div>
            <div af-view="modal-login" className="af-class-page-wrapper">
              ...
              <div className="af-class-signup-modal3_component">
                ...
                <div data-w-id="0a5d1d6e-dda5-8f09-0051-fa3df3ee7ece" className="af-class-signup-modal3_background-overlay" />
              </div>
            </div>
            {/* [if lte IE 9]><![endif] */}
          </div>
